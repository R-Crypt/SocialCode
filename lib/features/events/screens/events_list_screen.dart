      ...
      appBar: AppBar(
        ...
        title: Text('EVENTS',
            style: GoogleFonts.outfit(
                fontWeight: FontWeight.w900, fontSize: 22, color: AppTheme.borderBlack)),
                  ...
                  Row(children: [
                    ...
                    Text(dateStr,
                        style: GoogleFonts.spaceMono(
                            fontSize: 10, color: AppTheme.borderBlack.withOpacity(0.7))),
                  ]),
                  ...
                  if (event.description != null) ...[
                    ...
                    Text(event.description!,
                        ...
                        style: GoogleFonts.inter(
                            fontSize: 13, color: AppTheme.borderBlack.withOpacity(0.7))),
                  ],
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: event.isSoldOut ? Colors.grey : AppTheme.borderBlack,
...
class _EmptyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.event_busy, size: 56, color: AppTheme.borderBlack.withOpacity(0.15)),
            ...
            Text('Check back soon.',
                style: GoogleFonts.spaceMono(
                    fontSize: 11, color: AppTheme.borderBlack.withOpacity(0.4))),
          ],
        ),
      );
}
