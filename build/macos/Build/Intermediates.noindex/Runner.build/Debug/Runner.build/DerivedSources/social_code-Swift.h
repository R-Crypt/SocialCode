...
#ifndef SOCIAL_CODE_SWIFT_H
#define SOCIAL_CODE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="social_code",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11social_code11AppDelegate")
...
SWIFT_CLASS("_TtC11social_code17MainFlutterWindow")
